    ...
    */
    ...
    idGroup : [
        ...
        idGroup2 = function(str) {
            return str.match(/^(?:[a-f0-9]{8}|[A-F0-9]{8})$/) ? [
                'ADLER_32',
                'CRC_32B',
                'FCS_32',
                'GHASH_32_3',
        ...
        idGroup3 = function(str) {
            return str.match(/^(?:[a-f0-9]{6}|[A-F0-9]{6})$/) ? [
                'CRC_24',
            ] : false;
        },
        idGroup4 = function(str) {
            return str.match(/^(?:(\$crc32\$[a-f0-9]{8}.)?[a-f0-9]{8}|(\$CRC32\$[A-F0-9]{8}.)?[A-F0-9]{8})$/) ? [
                'CRC_32',
            ] : false;
        },
        idGroup5 = function(str) {
            return str.match(/^\+[a-z0-9\/.]{12}$/i) ? [
                'EGGDROP_IRC_BOT',
            ] : false;
        },
        idGroup6 = function(str) {
            return str.match(/^[a-z0-9\/.]{13}$/i) ? [
                'DES_TO_UNIX',
                'TRADITIONAL_DES',
                'DESCRYPT',
            ] : false;
        ...
        idGroup8 = function(str) {
            return str.match(/^[a-z0-9\/.]{16}$/i) ? [
                'CISCO_PIX_TO_MD5',
            ] : false;
        },
        idGroup9 = function(str) {
            return str.match(/^\([a-z0-9\/+]{20}\)$/i) ? [
                'LOTUS_NOTES_OR_DOMINO_6',
            ] : false;
        },
        idGroup10 = function(str) {
            return str.match(/^_[a-z0-9\/.]{19}$/i) ? [
                'BSDI_CRYPT',
            ] : false;
        },
        idGroup11 = function(str) {
            return str.match(/^(?:[a-f0-9]{24}|[A-F0-9]{24})$/) ? [
                'CRC_96_TO_ZIP',
            ] : false;
        },
        idGroup12 = function(str) {
            return str.match(/^[a-z0-9\/.]{24}$/i) ? [
                'CRYPT16',
            ] : false;
        },
        idGroup13 = function(str) {
            return str.match(/^(?:(\$md2\$)?[a-f0-9]{32}|(\$MD2\$)?[A-F0-9]{32})$/) ? [
                'MD2',
            ] : false;
        },
        ...
        idGroup15 = function(str) {
            return str.match(/^(?:(\$snefru\$)?[a-f0-9]{32}|(\$SNEFRU\$)?[A-F0-9]{32})$/) ? [
                'SNEFRU_128',
            ] : false;
        },
        idGroup16 = function(str) {
            return str.match(/^(?:(\$nt\$)?[a-f0-9]{32}|(\$NT\$)?[A-F0-9]{32})$/) ? [
                'NTLM',
            ] : false;
        },
        idGroup17 = function(str) {
            return str.match(/^([^\\\/:*?"<>|]{1,20}:)?(?:[a-f0-9]{32}|[A-F0-9]{32})(:[^\\\/:*?"<>|]{1,20})?$/) ? [
                'DOMAIN_CACHED_CREDENTIALS',
            ] : false;
        },
        idGroup18 = function(str) {
            return str.match(/^([^\\\/:*?"<>|]{1,20}:)?(\$(?:DCC2|dcc2)\$10240#[^\\\/:*?"<>|]{1,20}#)?(?:[a-f0-9]{32}|[A-F0-9]{32})$/) ? [
                'DOMAIN_CACHED_CREDENTIALS_2',
            ] : false;
        },
        idGroup19 = function(str) {
            return str.match(/^{SHA}[a-z0-9\/+]{27}=$/i) ? [
                'SHA_1_TO_BASE64',
                'NETSCAPE_LDAP_SHA',
            ] : false;
        },
        idGroup20 = function(str) {
            return str.match(/^\$1\$[a-z0-9\/.]{0,8}\$[a-z0-9\/.]{22}(:.*)?$/i) ? [
                'MD5_CRYPT',
                'CISCO_IOS_TO_MD5',
                'FREEBSD_MD5',
            ] : false;
        ...
        idGroup21 = function(str) {
            return str.match(/^(?:0x|0X)(?:[a-f0-9]{32}|[A-F0-9]{32})$/) ? [
                'LINEAGE_II_C4',
            ] : false;
        },
        idGroup22 = function(str) {
            return str.match(/^\$H\$[a-z0-9\/.]{31}$/i) ? [
                'PHPBB_V3_DOT_X',
                'WORDPRESS_V2_DOT_6_DOT_0_OR_2_DOT_6_DOT_1',
                'PHPASS_PORTABLE_HASH',
            ] : false;
        ...
        idGroup23 = function(str) {
            return str.match(/^\$P\$[a-z0-9\/.]{31}$/i) ? [
                'WORDPRESS_OVE_Q_V2_DOT_6_DOT_2',
                'JOOMLA_OVE_Q_V2_DOT_5_DOT_18',
                'PHPASS_PORTABLE_HASH',
            ] : false;
        ...
        idGroup24 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}|[A-F0-9]{32}):[a-zA-Z0-9]{2}$/) ? [
                'OSCOMMERCE',
                'XT_WITH_COMMERCE',
            ] : false;
        },
        idGroup25 = function(str) {
            return str.match(/^\$apr1\$[a-z0-9\/.]{0,8}\$[a-z0-9\/.]{22}$/i) ? [
                'MD5_TO_APR',
                'APACHE_MD5',
                'MD5APR1',
            ] : false;
        ...
        idGroup26 = function(str) {
            return str.match(/^{smd5}[a-z0-9$\/.]{31}$/i) ? [
                'AIX_TO_SMD5',
            ] : false;
        },
        idGroup27 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}:[a-f0-9]{32}|[A-F0-9]{32}:[A-F0-9]{32})$/) ? [
                'WEBEDITION_CMS',
            ] : false;
        },
        idGroup28 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}|[A-F0-9]{32}):.{5}$/) ? [
                'IP_DOT_BOARD_OVE_Q_V2_ADD',
            ] : false;
        },
        idGroup29 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}|[A-F0-9]{32}):.{8}$/) ? [
                'MYBB_OVE_Q_V1_DOT_2_ADD',
            ] : false;
        },
        idGroup30 = function(str) {
            return str.match(/^[a-z0-9]{34}$/i) ? [
                'CRYPTOCURRENCY_TO_ADRESS',
            ] : false;
        },
        ...
        idGroup33 = function(str) {
            return str.match(/^[a-z0-9]{43}$/i) ? [
                'CISCO_IOS_TO_SHA_256',
            ] : false;
        },
        idGroup34 = function(str) {
            return str.match(/^{SSHA}[a-z0-9\/+]{38}==$/i) ? [
                'SSHA_1_TO_BASE64',
                'NETSCAPE_LDAP_SSHA',
                'NSLDAPS',
            ] : false;
        ...
        idGroup35 = function(str) {
            return str.match(/^[a-z0-9=]{47}$/i) ? [
                'FORTIGATE_TO_FORTIOS',
            ] : false;
        },
        idGroup36 = function(str) {
            return str.match(/^(?:[a-f0-9]{48}|[A-F0-9]{48})$/) ? [
                'HAVAL_192',
                'TIGER_192',
                'SHA_1_TO_ORACLE',
                'OSX_V10_DOT_4',
        ...
        idGroup37 = function(str) {
            return str.match(/^(?:[a-f0-9]{51}|[A-F0-9]{51})$/) ? [
                'PALSHOP_CMS',
            ] : false;
        },
        idGroup38 = function(str) {
            return str.match(/^[a-z0-9]{51}$/i) ? [
                'CRYPTOCURRENCY_TO_PRIVATEKEY',
            ] : false;
        },
        idGroup39 = function(str) {
            return str.match(/^{ssha1}[0-9]{2}\$[a-z0-9$\/.]{44}$/i) ? [
                'AIX_TO_SSHA1',
            ] : false;
        },
        idGroup40 = function(str) {
            return str.match(/^0[xX]0100(?:[a-f0-9]{48}|[A-F0-9]{48})$/) ? [
                'MSSQL_TO_2005',
                'MSSQL_TO_2008',
            ] : false;
        },
        idGroup41 = function(str) {
            return str.match(/^(\$md5,rounds=[0-9]+\$|\$md5\$rounds=[0-9]+\$|\$md5\$)[a-z0-9\/.]{0,16}(\$|\$\$)[a-z0-9\/.]{22}$/i) ? [
                'SUN_MD5_CRYPT',
            ] : false;
        },
        idGroup42 = function(str) {
            return str.match(/^(?:[a-f0-9]{56}|[A-F0-9]{56})$/) ? [
                'SHA_224',
                'HAVAL_224',
                'SHA3_224',
                'SKEIN_256_TO_224',
        ...
        idGroup43 = function(str) {
            return str.match(/^(\$2[axy]|\$2)\$[0-9]{2}\$[a-z0-9\/.]{53}$/i) ? [
                'BLOWFISH_TO_OPENBSD',
                'WOLTLAB_BURNING_BOARD_4_DOT_X',
                'BCRYPT',
            ] : false;
        ...
        idGroup44 = function(str) {
            return str.match(/^(?:[a-f0-9]{40}:[a-f0-9]{16}|[A-F0-9]{40}:[A-F0-9]{16})$/) ? [
                'ANDROID_PIN',
            ] : false;
        },
        idGroup45 = function(str) {
            return str.match(/^([sS]:)?(?:[a-f0-9]{40}(:)?[a-f0-9]{20}|[A-F0-9]{40}(:)?[A-F0-9]{20})$/) ? [
                'ORACLE_11G_OR_12C',
            ] : false;
        },
        idGroup46 = function(str) {
            return str.match(/^\$bcrypt-sha256\$(2[axy]|2)\,[0-9]+\$[a-z0-9\/.]{22}\$[a-z0-9\/.]{31}$/i) ? [
                'BCRYPT_TO_SHA_256',
            ] : false;
        },
        idGroup47 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}|[A-F0-9]{32}):.{3}$/) ? [
                'VBULLETIN_UND_V3_DOT_8_DOT_5',
            ] : false;
        },
        idGroup48 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}|[A-F0-9]{32}):.{30}$/) ? [
                'VBULLETIN_OVE_Q_V3_DOT_8_DOT_5',
            ] : false;
        },
        idGroup49 = function(str) {
            return str.match(/^(\$(?:snefru|SNEFRU)\$)?(?:[a-f0-9]{64}|[A-F0-9]{64})$/) ? [
                'SNEFRU_256',
            ] : false;
        },
        idGroup50 = function(str) {
            return str.match(/^(?:[a-f0-9]{64}|[A-F0-9]{64})(:.+)?$/) ? [
                'SHA_256',
                'RIPEMD_256',
                'HAVAL_256',
                'GOST_R_34_DOT_11_94',
        ...
        idGroup50_1 = function(str) {
            return str.match(/^\$(sha256|SHA256)\$([a-z0-9]{8}\$[a-z0-9]{64}|[A-Z0-9]{8}\$[A-Z0-9]{64})$/i) ? [
                'SHA256_TO_DOL_SALT_DOT_DOL_PASS',
            ] : false;
        },

        idGroup51 = function(str) {
            return str.match(/^(?:[a-f0-9]{32}|[A-F0-9]{32}):[a-zA-Z0-9]{32}$/) ? [
                'JOOMLA_UND_V2_DOT_5_DOT_18',
            ] : false;
        },
        ...
        idGroup53 = function(str) {
            return str.match(/^(\$(?:chap|CHAP)\$0\*)?(?:[a-f0-9]{32}[\*:][a-f0-9]{32}(:[0-9]{2})?|[A-F0-9]{32}[\*:][A-F0-9]{32}(:[0-9]{2})?)$/) ? [
                'MD5_TO_CHAP',
                'ISCSI_CHAP_AUTHENTICATION',
            ] : false;
        },
        idGroup54 = function(str) {
            return str.match(/^\$episerver\$\*0\*[a-z0-9\/=+]+\*[a-z0-9\/=+]{27,28}$/i) ? [
                'EPISERVER_6_DOT_X_UND_V4',
            ] : false;
        },
        idGroup55 = function(str) {
            return str.match(/^{ssha256}[0-9]{2}\$[a-z0-9$\/.]{60}$/i) ? [
                'AIX_TO_SSHA256',
            ] : false;
        },
        idGroup56 = function(str) {
            return str.match(/^(?:[a-f0-9]{80}|[A-F0-9]{80})$/) ? [
                'RIPEMD_320',
            ] : false;
        },
        idGroup57 = function(str) {
            return str.match(/^\$episerver\$\*1\*[a-z0-9\/=+]+\*[a-z0-9\/=+]{42,43}$/i) ? [
                'EPISERVER_6_DOT_X_OVE_Q_V4',
            ] : false;
        },
        idGroup58 = function(str) {
            return str.match(/^(0x0100|0X0100)(?:[a-f0-9]{88}|[A-F0-9]{88})$/) ? [
                'MSSQL_TO_2000',
            ] : false;
        },
        idGroup59 = function(str) {
            return str.match(/^(?:[a-f0-9]{96}|[A-F0-9]{96})$/) ? [
                'SHA_384',
                'SHA3_384',
                'SKEIN_512_TO_384',
                'SKEIN_1024_TO_384',
        ...
        idGroup60 = function(str) {
            return str.match(/^{SSHA512}[a-z0-9\/+]{96}$/i) ? [
                'SSHA_512_TO_BASE64',
                'LDAP_TO_SSHA_512',
            ] : false;
        },
        idGroup61 = function(str) {
            return str.match(/^{ssha512}[0-9]{2}\$[a-z0-9\/.]{16,48}\$[a-z0-9\/.]{86}$/i) ? [
                'AIX_TO_SSHA512',
            ] : false;
        },
        idGroup62 = function(str) {
            return str.match(/^(?:[a-f0-9]{128}|[A-F0-9]{128})(:.+)?$/) ? [
                'SHA_512',
                'WHIRLPOOL',
                'SALSA10',
                'SALSA20',
        ...
        idGroup63 = function(str) {
            return str.match(/^(?:[a-f0-9]{136}|[A-F0-9]{136})$/) ? [
                'OSX_V10_DOT_7',
            ] : false;
        },
        idGroup64 = function(str) {
            return str.match(/^(0x0200|0X0200)(?:[a-f0-9]{136}|[A-F0-9]{136})$/) ? [
                'MSSQL_TO_2012',
                'MSSQL_TO_2014',
            ] : false;
        },
        idGroup65 = function(str) {
            return str.match(/^\$(ml|ML)\$[0-9]+\$(?:[a-f0-9]{64}\$[a-f0-9]{128}|[A-F0-9]{64}\$[A-F0-9]{128})$/) ? [
                'OSX_V10_DOT_8',
                'OSX_V10_DOT_9',
            ] : false;
        },
        idGroup66 = function(str) {
            return str.match(/^(?:[a-f0-9]{256}|[A-F0-9]{256})$/) ? [
                'SKEIN_1024',
            ] : false;
        },
        idGroup67 = function(str) {
            return str.match(/^(grub\.pbkdf2\.sha512\.|GRUB\.PBKDF2\.SHA512\.)[0-9]+\.(?:([a-f0-9]{128,2048}\.|[0-9]+\.)?[a-f0-9]{128}|([A-F0-9]{128,2048}\.|[0-9]+\.)?[A-F0-9]{128})$/) ? [
                'GRUB_2',
            ] : false;
        },
        idGroup68 = function(str) {
            return str.match(/^sha1\$[a-zA-Z0-9]+\$(?:[a-f0-9]{40}|[A-F0-9]{40})$/) ? [
                'DJANGO_TO_SHA_1',
            ] : false;
        },
        idGroup69 = function(str) {
            return str.match(/^(?:[a-f0-9]{49}|[A-F0-9]{49})$/) ? [
                'CITRIX_NETSCALER',
            ] : false;
        },
        idGroup70 = function(str) {
            return str.match(/^\$S\$[a-z0-9\/.]{52}$/i) ? [
                'DRUPAL_OVE_V7_DOT_X',
            ] : false;
        },
        idGroup71 = function(str) {
            return str.match(/^\$5\$(rounds=[0-9]+\$)?[a-z0-9\/.]{0,16}\$[a-z0-9\/.]{43}$/i) ? [
                'SHA_256_CRYPT',
            ] : false;
        },
        ...
        idGroup72 = function(str) {
            return str.match(/^0[xX](?:[a-f0-9]{84}|[A-F0-9]{84})$/) ? [
                'SYBASE_ASE',
            ] : false;
        },
        idGroup73 = function(str) {
            return str.match(/^\$6\$(rounds=[0-9]+\$)?[a-z0-9\/.]{0,16}\$[a-z0-9\/.]{86}$/i) ? [
                'SHA_512_CRYPT',
            ] : false;
        },
        idGroup74 = function(str) {
            return str.match(/^\$(?:sha|SHA)\$[a-zA-Z0-9]{1,16}\$(?:([a-f0-9]{32}|[a-f0-9]{40}|[a-f0-9]{64}|[a-f0-9]{128}|[a-f0-9]{140})|([A-F0-9]{32}|[A-F0-9]{40}|[A-F0-9]{64}|[A-F0-9]{128}|[A-F0-9]{140}))$/) ? [
                'MINECRAFT_TO_AUTHME_RELOADED',
            ] : false;
        },
        idGroup75 = function(str) {
            return str.match(/^(?:sha256|SHA256)\$[a-zA-Z0-9]+\$(?:[a-f0-9]{64}|[A-F0-9]{64})$/) ? [
                'DJANGO_TO_SHA_256',
            ] : false;
        },
        idGroup76 = function(str) {
            return str.match(/^(?:sha384|SHA384)\$[a-zA-Z0-9]+\$([a-f0-9]{96}|[A-F0-9]{96})$/) ? [
                'DJANGO_TO_SHA_384',
            ] : false;
        },
        idGroup77 = function(str) {
            return str.match(/^crypt1:[a-z0-9+=]{12}:[a-z0-9+=]{12}$/i) ? [
                'CLAVISTER_SECURE_GATEWAY',
            ] : false;
        },
        idGroup78 = function(str) {
            return str.match(/^(?:[a-f0-9]{112}|[A-F0-9]{112})$/) ? [
                'CISCO_VPN_CLIENT_TO_PCF_FILE',
            ] : false;
        },
        idGroup79 = function(str) {
            return str.match(/^(?:[a-f0-9]{1329}|[A-F0-9]{1329})$/) ? [
                'MICROSOFT_MSTSC_TO_RDP_FILE',
            ] : false;
        },
        ...
        idGroup83 = function(str) {
            return str.match(/^\$scram\$[0-9]+\$[a-z0-9\/.]{16}\$sha-1=[a-z0-9\/.]{27},sha-256=[a-z0-9\/.]{43},sha-512=[a-z0-9\/.]{86}$/i) ? [
                'SCRAM_HASH',
            ] : false;
        },
        ...
        idGroup93 = function(str) {
            return str.match(/^[a-z0-9\/.]{16}([:$].{1,})?$/i) ? [
                'CISCO_ASA_TO_MD5',
            ] : false;
        },
        ...
        idGroup95 = function(str) {
            return str.match(/^[a-z0-9]{32}(:([a-z0-9-]+\.)?[a-z0-9-.]+\.[a-z]{2,7}:.+:[0-9]+)?$/i) ? [
                'DNSSEC_TO_NSEC3',
            ] : false;
        },
        ...
        idGroup98 = function(str) {
            return str.match(/^\$sha1\$[0-9]+\$[a-z0-9\/.]{0,64}\$[a-z0-9\/.]{28}$/i) ? [
                'SHA_1_CRYPT',
            ] : false;
        },
        ...
        idGroup102 = function(str) {
            return str.match(/^\$pbkdf2(-sha1)?\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{27}$/i) ? [
                'PBKDF2_SHA1_TO_GENERIC',
            ] : false;
        },
        idGroup103 = function(str) {
            return str.match(/^\$pbkdf2-sha256\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{43}$/i) ? [
                'PBKDF2_SHA256_TO_GENERIC',
            ] : false;
        },
        idGroup104 = function(str) {
            return str.match(/^\$pbkdf2-sha512\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{86}$/i) ? [
                'PBKDF2_SHA512_TO_GENERIC',
            ] : false;
        },
        idGroup105 = function(str) {
            return str.match(/^\$p5k2\$[0-9]+\$[a-z0-9\/+=-]+\$[a-z0-9\/+-]{27}=$/i) ? [
                'PBKDF2_TO_CRYPTACULAR',
            ] : false;
        },
        idGroup106 = function(str) {
            return str.match(/^\$p5k2\$[0-9]+\$[a-z0-9\/.]+\$[a-z0-9\/.]{32}$/i) ? [
                'PBKDF2_TO_DWAYNE_LITZENBERGER',
            ] : false;
        },
        idGroup107 = function(str) {
            return str.match(/^{FSHP[0123]\|[0-9]+\|[0-9]+}[a-z0-9\/+=]+$/i) ? [
                'FAIRLY_SECURE_HASHED_PASSWORD',
            ] : false;
        },
        ...
        idGroup115 = function(str) {
            return str.match(/^(\$django\$\*1\*)?pbkdf2_sha256\$[0-9]+\$[a-z0-9]+\$[a-z0-9\/+=]{44}$/i) ? [
                'DJANGO_TO_PBKDF2_HMAC_SHA256',
            ] : false;
        },
        idGroup116 = function(str) {
            return str.match(/^pbkdf2_sha1\$[0-9]+\$[a-z0-9]+\$[a-z0-9\/+=]{28}$/i) ? [
                'DJANGO_TO_PBKDF2_HMAC_SHA1',
            ] : false;
        },
        idGroup117 = function(str) {
            return str.match(/^bcrypt(\$2[axy]|\$2)\$[0-9]{2}\$[a-z0-9\/.]{53}$/i) ? [
                'DJANGO_TO_BCRYPT',
            ] : false;
        },
        ...
        idGroup119 = function(str) {
            return str.match(/^\{PKCS5S2\}[a-z0-9\/+]{64}$/i) ? [
                'PBKDF2_TO_ATLASSIAN',
            ] : false;
        },
        ...
        idGroup121 = function(str) {
            return str.match(/^\([a-z0-9\/+]{49}\)$/i) ? [
                'LOTUS_NOTES_OR_DOMINO_8',
            ] : false;
        },
        idGroup122 = function(str) {
            return str.match(/^SCRYPT:[0-9]{1,}:[0-9]{1}:[0-9]{1}:[a-z0-9:\/+=]{1,}$/i) ? [
                'SCRYPT',
            ] : false;
        },
        idGroup123 = function(str) {
            return str.match(/^\$8\$[a-z0-9\/.]{14}\$[a-z0-9\/.]{43}$/i) ? [
                'CISCO_TYPE_8',
            ] : false;
        },
        idGroup124 = function(str) {
            return str.match(/^\$9\$[a-z0-9\/.]{14}\$[a-z0-9\/.]{43}$/i) ? [
                'CISCO_TYPE_9',
            ] : false;
        },
        idGroup125 = function(str) {
            return str.match(/^\$office\$\*2007\*[0-9]{2}\*[0-9]{3}\*[0-9]{2}\*[a-z0-9]{32}\*[a-z0-9]{32}\*[a-z0-9]{40}$/i) ? [
                'MICROSOFT_OFFICE_2007',
            ] : false;
        },
        idGroup126 = function(str) {
            return str.match(/^\$office\$\*2010\*[0-9]{6}\*[0-9]{3}\*[0-9]{2}\*[a-z0-9]{32}\*[a-z0-9]{32}\*[a-z0-9]{64}$/i) ? [
                'MICROSOFT_OFFICE_2010',
            ] : false;
        },
        idGroup127 = function(str) {
            return str.match(/^\$office\$\*2013\*[0-9]{6}\*[0-9]{3}\*[0-9]{2}\*[a-z0-9]{32}\*[a-z0-9]{32}\*[a-z0-9]{64}$/i) ? [
                'MICROSOFT_OFFICE_2013',
            ] : false;
        },
        ...
        idGroup132 = function(str) {
            return str.match(/^{x-issha,\s[0-9]{4}}[a-z0-9\/+=]+$/i) ? [
                'SAP_CODVN_H_TO_PWDSALTEDHASH_ISSHA_1',
            ] : false;
        },
        idGroup133 = function(str) {
            return str.match(/^\$cram_md5\$[a-z0-9\/+=-]+\$[a-z0-9\/+=-]{52}$/i) ? [
                'CRAM_MD5',
            ] : false;
        },
        ...
        idGroup137 = function(str) {
            return str.match(/^(\$cisco4\$)?[a-z0-9\/.]{43}$/i) ? [
                'CISCO_TYPE_4',
            ] : false;
        },
        idGroup138 = function(str) {
            return str.match(/^bcrypt_sha256\$\$(2[axy]|2)\$[0-9]+\$[a-z0-9\/.]{53}$/i) ? [
                'DJANGO_TO_BCRYPT_SHA256',
            ] : false;
        },
        ...
        idGroup142 = function(str) {
            return str.match(/^sha256[:$][0-9]+[:$][a-z0-9\/+]+[:$][a-z0-9\/+]{32,128}$/i) ? [
                'PBKDF2_HMAC_SHA256_TO_PHP',
            ] : false;
        },
        idGroup143 = function(str) {
            return str.match(/^(\$dahua\$)?[a-z0-9]{8}$/i) ? [
                'DAHUA',
            ] : false;
        },
